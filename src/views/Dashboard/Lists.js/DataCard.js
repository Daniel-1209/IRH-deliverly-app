...
import avatarProfile from '../../../../assets/sinFoto.jpeg';

const DataCard = ({dataStudent}) => {
  const {attributes} = dataStudent;
  // console.log(JSON.stringify(attributes.photo, ' ', 2));

  return (
    <View style={styles.viewStudentContent}>
      <Text style={styles.titleCard}>INFORMACIÓN DEL BENEFICIARIO</Text>
      ...
      <View
        ...
        <View style={styles.viewColumsContent}>
          <Image style={styles.imageAvatar} source={avatarProfile} />
        </View>
        <View style={styles.viewColumsContent}>
